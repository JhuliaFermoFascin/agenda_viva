...
export default function Especialidades() {
  ...
  return (
    <>
      <Navbar />
      <Sidebar />
      <main className="flex-1 p-6 ml-40 transition-all duration-300 flex flex-col bg-gray-100">
        <h1 className="text-2xl font-bold mb-6 mt-10 ml-10 text-[#023047]">
          Cadastro de Especialidade
        </h1>
        <div className="bg-white rounded-lg shadow-md p-6 w-full max-w-4xl mx-auto">
          {/* Botão de adicionar e pesquisa */}
          ...
          <div className="mt-4 flex justify-between items-center text-sm">
            ...
            <div className="flex space-x-2">
              <button className="px-3 py-1 border border-gray-200 rounded-md bg-gray-100 hover:bg-gray-300">
                <IconVoltar />
              </button>
              <button className="px-3 py-1 border border-gray-200 rounded-md bg-gray-100 hover:bg-gray-300">
                1
